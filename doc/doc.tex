...
\begin{figure}[t!]
    ...
    \caption{
        ...
        spectrum histories from data overlayed with predictions. Trajectories
        are smoothed using LOESS regression.
    }
...
\citep[][and see Figure 3, supplement 2 in
\citet{gao2023limited}]{bergeron2022mutationathon}.
